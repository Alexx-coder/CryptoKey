...
WORDLIST = r'c:\Users\ВашЮзер\Downloads\eff_large_wordlist.txt' #Надо скачать файл по адресу "https://www.eff.org/files/2016/07/18/eff_large_wordlist.txt", затем указать путь к файлу (Тут мой путь)
    ...
    def seed_password(self):
     ...
     while True:
        try:
            ...
            print("Файл eff_large_wordlist.txt не найден! Скачайте данный файл на сайте (https://www.eff.org/files/2016/07/18/eff_large_wordlist.txt), затем в переменнйо ставьте путь файла.")
            break
